...
| `debate.md` | Reconcile independently-derived work with an Architect from another provider. Determine your model first and stop if it is below Architect - read `universal/harness-codex.md` or `universal/harness-claude-code.md` for how, before the file, the brief, or anything else |
